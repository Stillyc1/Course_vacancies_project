class Vacancy:
    ...
    def __init__(self, name: str = "не указан", url: str = "не указан", snippet: str = "не указан", salary: str = None):
        ...
        if salary is not None:
            ...
            if type(salary) is str:
                ...
                self.__salary = {"from": int(salary_split[0]),
                                 "to": int(salary_split[2])}
        else:
...
if __name__ == "__main__":
    ...
    rob2 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
                   "100000 - 150000")
    rob3 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
                   "110000 - 160000")
    rob4 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
                   "120000 - 170000")
    rob5 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
                   "130000 - 180000")
    rob6 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
                   "140000 - 190000")
    rob7 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
                   "150000 - 200000")
    # rob8 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
    #                "160000")
    rob9 = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", "Требования: опыт работы от 3 лет...",
                   "0 - 220000")
